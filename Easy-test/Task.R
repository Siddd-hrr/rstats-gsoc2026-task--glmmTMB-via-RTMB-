...
writeLines(kable(summary(Salamanders,format = "html")), "Easy-test/results/Salamanders_summary.html")



#Salamanders dataset head:
print(kable(head(Salamanders),format = "markdown"))
writeLines(kable(head(Salamanders,format = "html")), "Easy-test/results/Salamanders_head.html")
...
writeLines(kable(as.data.frame(summary(m1)$coefficients$cond,format = "html")), "Easy-test/results/Salamanders_model1.html")
...
writeLines(kable(as.data.frame(summary(m3)$coefficients$cond, format = "html")), "Easy-test/results/Salamanders_model3.html")
...
writeLines(kable(as.data.frame(summary(m1_lme4)$coefficients, format = "html")), "Easy-test/results/Salamanders_model4.html")
...
ggsave("Easy-test/plots/random_effe_plot.png", p, width = 8, height = 6)
